...
public abstract class AbstractGame implements Game{
    static Integer sizeWord;
    static Integer maxTry;
    ...
    public static void showWord(){
        System.out.println("Правильный ответ: " + computerWord);
    }
    public static Integer getSizeWord() {
        return sizeWord;
    }
    public static Integer getMaxTry() {
        return maxTry;
    }
}
